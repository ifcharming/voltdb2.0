...
import org.procedures.*;

public class Client {

    /** Example SELECT: select rows matching the specified id parameter.
     *
     * Call <code>org.procedures.Select</code> passing
    ...
    private void doSelect(int id) {
        ...
        try {
            ...
            for (int ii = 0; ii < rowCount; ii++) {
                ...
                final long test1_ID = row.getLong(0);
                final long test1_ITEM = row.getLong(1);
                System.out.println("Selected: test1_ID == " + test1_ID + " test1_ITEM == " + test1_ITEM);
            }
     ...
     * and item parameters.
     *
     * Call <code>org.procedures.Insert</code> passing
     ...
     *
     * Call <code>org.procedures.Insert</code> with an
     ...
     *
     *  Call <code>org.procedures.Delete</code> passing
