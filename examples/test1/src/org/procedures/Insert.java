...
*/
@ProcInfo(
    partitionInfo = "TEST1.TEST1_ID: 0",
    singlePartition = true
)
public class Insert extends VoltProcedure {

    public final SQLStmt insertItem = new SQLStmt("INSERT INTO test1 VALUES (?, ?);");

    public long run( int TEST1_ID, long TEST1_ITEM ) throws VoltAbortException {
        // Add a SQL statement to the execution queue.
        voltQueueSQL( insertItem, TEST1_ID, TEST1_ITEM );
