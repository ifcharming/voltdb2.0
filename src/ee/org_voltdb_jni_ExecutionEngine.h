 ...
 * Signature: (JIIIILjava/lang/String;J)I
 */
JNIEXPORT jint JNICALL Java_org_voltdb_jni_ExecutionEngine_nativeInitialize
  (JNIEnv *, jobject, jlong, jint, jint, jint, jint, jstring, jlong);
 ...
 * Signature: (JZJJLjava/lang/String;)J
 */
JNIEXPORT jlong JNICALL Java_org_voltdb_jni_ExecutionEngine_nativeExportAction
  (JNIEnv *, jobject, jlong, jboolean, jlong, jlong, jstring);
