...
public class VoltDB {
	...
	public static class Configuration {
		...
		/** true if we want to activate active-passive mode. */
		public boolean m_useActivePassive = false;
		...
		public Configuration(String args[]) {
			...
			for (int i=0; i < args.length; ++i) {
				...
				} else if (arg.equalsIgnoreCase("useActivePassive")) {
					m_useActivePassive = true;
				} else {
	...
	public static boolean getUseActivePassive() {
		return m_config.m_useActivePassive;
	}
