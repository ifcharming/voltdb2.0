...
public abstract class VoltProcedure {
	...
	final private Object tryToMakeCompatible(int paramTypeIndex, Object param) throws Exception {
		...
		if ((slot == long.class) && (pclass == Long.class || pclass == Integer.class || pclass == Short.class || pclass == Byte.class)) {
			return param;
		}
		if ((slot == int.class) && (pclass == Integer.class || pclass == Short.class || pclass == Byte.class)) {
			return param;
		}
		if ((slot == short.class) && (pclass == Short.class || pclass == Byte.class)) {
			return param;
		}
		if ((slot == byte.class) && (pclass == Byte.class)) {
			return param;
		}
		if ((slot == double.class) && (param instanceof Number)) {
			return ((Number)param).doubleValue();
		}
		if ((slot == String.class) && (pclass == String.class)) {
			return param;
		}
