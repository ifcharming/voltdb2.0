...
public abstract class VoltMessage {
	...
	final public static byte PHYSICAL_LOG_UPDATE_ID = 15;
	final public static byte PHYSICAL_LOG_RESPONSE_ID = 16;
	...
	private static VoltMessage instantiate(byte messageType) {
		...
		case BINARY_PAYLOAD_ID:
			...
			break;
		case PHYSICAL_LOG_UPDATE_ID:
			message = new PhysicalLogUpdateMessage();
			break;
		case PHYSICAL_LOG_RESPONSE_ID:
			message = new PhysicalLogResponseMessage();
			break;
		default:
